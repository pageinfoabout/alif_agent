...
import phonenumbers
from phonenumbers import parse, PhoneNumberFormat  # For normalize_phone()
...
7. Так же если пациент хочет отменить запись, то спроси на какое число он записался и удали запись
